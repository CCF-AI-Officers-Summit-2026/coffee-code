...
2. Send your github username to leon@centerforcivicfutures.org so he can invite you to the github organization that we've set up for the event
3. Accept the invite
4. Make sure you can run a github codespace (see below).
